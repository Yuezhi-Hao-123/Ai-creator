...
/**
 * TopicCard — displays a single topic idea with expandable description.
 * Includes a button to navigate to Content Plan with this topic.
 */
      ...
      <p className="mt-2 text-sm text-[var(--color-muted)] leading-relaxed flex-1">
        ...
        {idea.description.length > 100 && (
          <button
            ...
            className="ml-1 text-[var(--color-primary)] hover:underline text-sm cursor-pointer"
          >
